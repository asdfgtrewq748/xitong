...
```powershell
# 使用正确的 Python 环境启动
C:/ProgramData/anaconda3/Scripts/conda.exe run -p "C:\Users\Liu HaoTian\.conda\envs\kan" --no-capture-output python d:\xitong\kYYC_gui.py
```
...
# 2. 启动 GUI
python d:\xitong\kYYC_gui.py
```

### 测试数据文件

系统已生成测试数据供 GUI 使用：
- `d:\xitong\test_kyyc_data.csv`
- `d:\xitong\test_kyyc_data.npz`
