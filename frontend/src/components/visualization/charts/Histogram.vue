...
<script setup name="HistogramChart">
/* eslint-disable no-undef */
import { ref, onMounted, onBeforeUnmount, watch, nextTick } from 'vue'
import { ChartWrapper, generateHistogramOption } from '../../../utils/chartWrapper'
...
const updateChart = () => {
  ...
  if (!hasValidData) {
    ...
    chartWrapper.value.update({
      title: { text: props.config.title || '直方图', left: 'center' },
  ...
  const option = generateHistogramOption(props.data, props.config)
