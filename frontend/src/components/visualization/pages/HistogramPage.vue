  ...
  <div class="chart-page modern-layout">
    <div class="page-header modern">
      <div class="title-group">
        <h2><el-icon><DataAnalysis /></el-icon> 直方图</h2>
        <p class="subtitle">数据分布频率分析</p>
      </div>
            ...
            <el-collapse-item title="字段映射" name="mapping">
              <el-form label-position="top" size="small" class="compact-form">
                ...
                <el-form-item label="分箱数量">
                  <el-input-number v-model="config.bins" :min="5" :max="100" @change="updateChart" />
                </el-form-item>
              </el-form>
            </el-collapse-item>
            ...
            <el-collapse-item title="高级选项" name="advanced">
              <el-form label-position="top" size="small" class="compact-form">
                ...
                <el-form-item label="Y轴标签">
                  <el-input v-model="config.yAxisLabel" placeholder="频数" @change="updateChart" />
                </el-form-item>
                ...
                <el-form-item>
                  <el-switch v-model="config.showLabel" active-text="显示数值" @change="updateChart" />
                </el-form-item>
      ...
      <main class="chart-display modern">
        <div class="summary-cards">
          <el-card shadow="hover" class="summary-card">
            <div class="card-content">
              ...
              <div class="card-info">
                <div class="card-value">{{ config.bins }}</div>
                <div class="card-label">分箱数</div>
              </div>
            </div>
          </el-card>
          <el-card shadow="hover" class="summary-card">
        ...
        <el-card shadow="hover" class="chart-card">
          ...
          <div class="chart-wrapper">
            ...
            <histogram-chart v-else ref="chartRef" :data="chartData" :config="fullChartConfig" :height="560" />
          </div>
        </el-card>
      </main>
    </div>
...
import { DataAnalysis, QuestionFilled, RefreshLeft, DataLine, Document } from '@element-plus/icons-vue'
...
const updateChart = () => {
  if (!store.currentDataset || !config.xField) return
  try {
