    ...
    <div class="page-content">
      <aside class="sidebar">
        ...
        <el-card shadow="never" style="margin-top: 16px;">
          ...
          <chart-settings-panel :config="config" chart-type="bar" @apply="onSettingsApply" compact />
        </el-card>
      </aside>
      ...
      <main class="chart-area">
        ...
        <div class="chart-container">
          ...
          <bar-chart v-else ref="chartRef" :data="chartData" :config="chartConfig" :height="500" />
        </div>
      </main>
...
import { Histogram, QuestionFilled, RefreshLeft, Download } from '@element-plus/icons-vue'
...
const exportChart = (format) => {
  chartRef.value?.exportChart?.({ type: format, filename: `bar_chart_${Date.now()}` })
